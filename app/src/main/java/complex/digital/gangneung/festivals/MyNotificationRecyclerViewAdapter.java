...
import complex.digital.gangneung.festivals.dummy.DummyContent.DummyItem;
...
public class MyNotificationRecyclerViewAdapter extends RecyclerView.Adapter<MyNotificationRecyclerViewAdapter.ViewHolder> {
    ...
    public MyNotificationRecyclerViewAdapter(List<DummyItem> items, NotificationFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
